...
def get_activations(files, model, batch_size=50, dims=2048, device='cpu',
    ...
    # dataset = ImagePathDataset(files, transforms=TF.Compose([TF.Resize((192, 192)), TF.ToTensor()]))
    ...
    # dataset = ImagePathDataset(files, transforms=TF.Compose([TF.Resize((384, 384)), TF.ToTensor()]))
    # dataset = ImagePathDataset(files, transforms=TF.Compose([TF.Resize((448, 448)), TF.ToTensor()]))
